...
coinbase.extracted <- reconstruct("Coinbase", coinbase.full, extract.only=TRUE)[lubridate::ceiling_date(timestamp) == '2020-04-01 16:51:57',]
setDT(bitstamp.quotes)
setDT(bitstamp.trades)
...
save( coinbase.extracted, bitstamp.extracted, finex.q.1, finex.t.1, file="oberon.Rdata", compress=TRUE)
