...
coinbase.extracted <- reconstruct(coinbase.full, TRUE)[ceiling_date(timestamp) == '2020-04-01 16:51:57',]

save(stamp.q.1, stamp.t.1, finex.q.1, finex.t.1, coinbase.extracted, file="oberon.Rdata", compress=TRUE)
